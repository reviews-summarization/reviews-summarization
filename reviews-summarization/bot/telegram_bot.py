...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await context.bot.send_message(chat_id=update.effective_chat.id, text="Отправьте ссылку на фильм с кинопоиска https://www.kinopoisk.ru/?utm_referrer=www.google.com")
